heatmap_ices_rect_one_var<-function(x, Var, F, map.title, legend.title, nbreaks, xlim = c(-4.5,+14.5), ylim = c(49.75,62.25), legend.amp=1){
...
# Example
	#heatmap_ices_rect_one_var(x=data1$ceSub, Var = "KWDays", F = sum, map.title = "sum KWDays", xlim=c(-4.5,+14.5), ylim=c(49.75,62.25), legend.title="sum KWDays", nbreaks=6)
...
par(new=T);plot(a, xlim=xlim, ylim=ylim, bg=FALSE, col="gray")
